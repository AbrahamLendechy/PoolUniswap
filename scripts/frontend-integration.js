 ...
 * This file demonstrates how to integrate Pooluniswapswap with a web frontend
 */

// For React/Vue/Angular applications
export class PooluniswapswapClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PooluniswapswapClient(provider, contractAddress);
